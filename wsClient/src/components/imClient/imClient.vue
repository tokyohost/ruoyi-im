...
export default {
    ...
    methods: {
        ...
        regSocket: function(serverChatId) {
            this.$data.socket = new WebsocketHeartbeatJs({url: 'ws://localhost:8070/im?uid=test'});
            ...
            // }
            // this.$data.socket = require('socket.io-client')('ws://localhost:8070',{path:"/im",transports: ['websocket'],query:{uid:"testuser"}});
            ...
            this.$data.socket.onreconnect = function() {
